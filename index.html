...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav id="scrollspy" class="navbar page-navbar navbar-light navbar-expand-md fixed-top" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="navbar-brand" href="#">
                <!-- <strong class="text-primary">Creative</strong> <span class="text-light">Design</span> -->
                <img src="assets/imgs/CDLogo.png" height="50px" alt="">
        </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item ml-md-4">
                        <a class="nav-link nav-link-comp btn btn-primary" href="components.html">Components</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <header id="home" class="header">
        ...
        <div class="header-content">
            ...
            <button class="btn btn-outline-light download-btn">Download Now</button> 
        </div>      
    ...
    <section id="contact" class="text-center">
        ...
        <div class="container">
            ...
            <!-- Contact form -->
            <form class="contact-form col-md-11 col-lg-9 mx-auto" method="POSt" action="sendmail.php">
                <div class="form-row">
                ...
                <div class="form-group">
                    <textarea name="message" id="" cols="30" rows="5" class="form-control" id="message"  placeholder="Your Message"></textarea>
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-primary btn-block" name="btn" value="Send Message">
                </div>
            ...
            <div class="pre-footer">
                <ul class="list">
                    ...
                    <li class="list-body">
                        ...
                        <a href="#"><strong class="text-primary">Creative</strong> <span class="text-light">Design</span></a>
                    </li>
                </ul>
                <ul class="list">
                    <li class="list-head">
    ...
    <script>
        ...
        function sendEmail(){
            Email.send({
                ...
                Username : "ahmedays001@gmail.com",
                Password : "828DEF881D6C699B757ECBD0545B72776F68",
                To : 'yasirays99@gmail.com',
                From : "ahmedays001@gmail.com",
                Subject : "NEw text",
                Body : "checking",
